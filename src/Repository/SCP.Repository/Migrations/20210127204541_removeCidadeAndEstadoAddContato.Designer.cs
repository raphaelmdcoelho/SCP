...
namespace SCP.Repository.Migrations
{
    ...
    [Migration("20210127204541_removeCidadeAndEstadoAddContato")]
    partial class removeCidadeAndEstadoAddContato
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCP.Domain.Contato.ContatoEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SCP.Domain.Historico.HistoricoEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SCP.Domain.Historico.HistoricoEntity", b =>
                {
                    ...
                    b.HasOne("SCP.Domain.Usuario.UsuarioEntity", "Usuario")
                        .WithMany("Historicos")
